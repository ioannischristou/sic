...
fid = fopen('snQTCnbinCompSporadicDemandQuantQT.new.txt', 'wt');
...
estop = 0;
tmin = epst;
tmax = 3.8;  % only used for the approx scheme
mint = 0;
minq = 0;
        ...
        for l=1:p_len
            ...
            for i=1:Kr_len
                ...
                for m=1:lamda_len
                    ...
                    tic;
                    [s Q T c] = snQTCnbinOptFastApprox4(Kr,K0,L,lamda,pl,h,p,p2,tmin,tmax,epsq,epst);
                    tEl2=toc;
