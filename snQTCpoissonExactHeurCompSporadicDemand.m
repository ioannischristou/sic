...
fid = fopen('snQTCpoissonCompSporadicDemand.new.txt', 'wt');
        ...
        for l=1:p_len
            ...
            for i=1:Kr_len
                ...
                for m=1:lamda_len
                    ...
                    tic;
                    [sopt Qopt Topt copt] = snQTCpoissonOptFast3SD(mint, Kr, K0, L, lamda, h, p, epsq, epst, estop, tmin);
                    tEl=toc;
                    disp(['computing heuristic (s,nQ,T) policies for m=' num2str(m)]);
                    tic;
                    [s Q T c] = snQTCpoissonOptFastApprox3(Kr,K0,L,lamda,h,p,p2,tmin);
                    tEl2=toc;
