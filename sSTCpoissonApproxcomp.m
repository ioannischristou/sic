...
fid = fopen('sSTCpoissonApprox2.txt', 'wt');
...
% Kr K0 h p s1 S1 T1 c1 time1 s2 S2 T2 c2 time2 

fprintf(fid, '    Kr ,     Ko ,      h ,      p , s1 , S1 , T1 , c1 , time1, s2 , S2 , T2 , c2 , time2\n');
    ...
    for k=1:h_len
        ...
        for l=1:p_len
            ...
            for i=1:Kr_len
                ...
                fprintf(fid,'%6.2f , %6.2f , %6.2f , %6.2f ,', Kr, K0, h, p);
                disp(['computing Approx policies for M=1 for Kr=' num2str(Kr)]);
                tic;
                [sopt Sopt Topt copt] = sSTCpoissonOptFastApproxM3(Kr, K0, L, lamda, h, p, p2, epsd, epst, tdelta, 1);
                tElapsed=toc;
                ...
                tic;
                [sopt Sopt Topt copt] = sSTCpoissonOptFastApproxM3(Kr, K0, L, lamda, h, p, p2, epsd, epst, tdelta, 2);
                tElapsed=toc;
                fprintf(fid,'%6.2f , %6.2f , %6.2f , %6.2f , %6.2f', sopt, Sopt, Topt, copt, tElapsed);
                fprintf(fid,'\n');
            end
