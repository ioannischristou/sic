function [sopt Qopt Topt costs] = snQTCnormOptGraph_T(Qmax,Tmax,Kr,K0,L,mi,sigma,h,p, epsq, epst)
if nargin < 10
    epsq = 1;
end
if nargin < 11
...
for i=1:Tlen
    ...
    for j=1:Qlen
        ...
        hbig = snQTCnorm(sqt,Q,T,Kr+K0,0,L,mi,sigma,h,p);
        hsmall = snQTCnorm(sqt,Q,T,Kr,0,L,mi,sigma,h,p);
        costs(j,i)=c;
        if c < copt
           cTi(i)=c;
           copt = c;
