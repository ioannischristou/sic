...
fid = fopen('snQTCnormCompQuantQT.new.txt', 'wt');
...
%tnot = 10^-6;
%tnot = (3*sigma/mi)^2;
tnot = 0.2;  % guarantee min. time adheres epst constraint
epst=0.05;
epsq=3.0;
qnot=3.0;
p2 = 0;
    ...
    for k=1:h_len
        ...
        for l=1:p_len
            ...
            for i=1:Kr_len
                ...
                tic;
                [s Q T c1 s2 q2 t2 c2 c] = snQTCnormOptFastApprox2(Kr,K0,L,mi,sigma,h,p,p2,epsq,epst);
                tEl2=toc;
