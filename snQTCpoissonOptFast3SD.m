function [sopt Qopt Topt copt Qmax Tmax copt2] = snQTCpoissonOptFast3SD(mint, Kr,K0,L,lamda,h,p,epsq,epst, estop, tmin, tmax)
...
if nargin < 10  % if this value is one, run only for Q=0, i.e. run (R,T) policy
    estop = 0;
end
